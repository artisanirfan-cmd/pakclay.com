...
4. **Match the design tokens in `02-DESIGN-SYSTEM.md`** rather than shadcn defaults — the palette is the white / blue / slate-gray PAKCLAY.COM system (2026-09-19 rebrand; it replaced the earlier warm terracotta/sand heritage palette). Use the tokens, never literal hex or named Tailwind colors, and check contrast for any new color pair.
